...
ifeq ($(BR2_PACKAGE_BUSYBOX_SMP),y)
define BUSYBOX_SET_SMP
	$(call KCONFIG_ENABLE_OPT,CONFIG_TOP,$(BUSYBOX_BUILD_CONFIG))
	$(call KCONFIG_ENABLE_OPT,CONFIG_FEATURE_TOP_SMP_CPU,$(BUSYBOX_BUILD_CONFIG))
	$(call KCONFIG_ENABLE_OPT,CONFIG_FEATURE_TOP_SMP_PROCESS,$(BUSYBOX_BUILD_CONFIG))
endef
endif
